...
const sttaddr = "0x84Cbd41ed3E5122490DaFE629f6969b2De657065";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x84Cbd41ed3E5122490DaFE629f6969b2De657065";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://ixoracoin.github.io/?ref=' + document.getElementById('refaddress').value;
}
}
}
